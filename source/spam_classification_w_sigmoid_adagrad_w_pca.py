...
def inferenceFunc(X_data):
    ...
    print "Accuracy:%f" %(correctly_classified/float(len(X_data))*100.0)
...
if choice=="yes": 
    ...
    if option=="yes":
        np.save("./weight_matrix_with_pca/Wh", Wh) 
        np.save("./weight_matrix_with_pca/bh", bh) 
        np.save("./weight_matrix_with_pca/Wh1", Wh1) 
        np.save("./weight_matrix_with_pca/bh1", bh1) 
        np.save("./weight_matrix_with_pca/Wo", Wo) 
        np.save("./weight_matrix_with_pca/bo", bo) 
else:
    print "Using the existing model"
    Wh=np.load("./weight_matrix_with_pca/Wh.npy")
    bh=np.load("./weight_matrix_with_pca/bh.npy")
    Wh1=np.load("./weight_matrix_with_pca/Wh1.npy")
    bh1=np.load("./weight_matrix_with_pca/bh1.npy")
    Wo=np.load("./weight_matrix_with_pca/Wo.npy")
    bo=np.load("./weight_matrix_with_pca/bo.npy")
